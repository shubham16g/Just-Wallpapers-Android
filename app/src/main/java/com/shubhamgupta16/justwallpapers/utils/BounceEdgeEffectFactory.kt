 ...
 */
class BounceEdgeEffectFactory(private val isHorizontal: Boolean = false) :
    ...
    override fun createEdgeEffect(recyclerView: RecyclerView, direction: Int): EdgeEffect {
        ...
        return object : EdgeEffect(recyclerView.context) {
            ...
            private fun handlePull(deltaDistance: Float) {
                ...
                val sign =
                    if (direction == DIRECTION_BOTTOM || direction == DIRECTION_RIGHT) -1 else 1
            ...
            override fun onRelease() {
                ...
                if ((isHorizontal && recyclerView.translationX != 0f) || (!isHorizontal && recyclerView.translationY != 0f)) {
